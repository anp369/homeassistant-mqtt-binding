...
class TestMQTTDevice(unittest.TestCase):
    ...
    def test_initialize(self, mocked_client):
        ...
        self.assertEqual(dev.conf_dict['unique_id'], self.unique_id)
    ...
    def test_device_mapping(self, mocked_client):
        ...
        dev = MqttDeviceBase(self.settings, False)
        self.assertTrue(dev.conf_dict['device'] == self.settings.device.get_dict())
    ...
    def test_entity_category(self, mocked_client):
        ...
        self.assertEqual("config", entity.conf_dict["entity_category"])
        ...
        self.assertNotIn("entity_category", entity2.conf_dict)
